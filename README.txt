...
```bash
# Clone the repo
git clone https://github.com/YOUR_USERNAME/runlog.git
cd runlog
...
**Mauro** · [LinkedIn](https://linkedin.com/in/YOUR_PROFILE) · [GitHub](https://github.com/YOUR_USERNAME)

Built as the final project for [CS50x](https://cs50.harvard.edu/x/) — Harvard's Introduction to Computer Science.